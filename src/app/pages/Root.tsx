...
export function Root() {
  ...
  return (
    <div className="flex absolute inset-0 overflow-hidden font-sans text-foreground bg-background justify-center">
      ...
      {/* Main Content Area */}
      <div 
        className="flex-1 flex flex-col overflow-hidden min-w-0 relative bg-background w-full shadow-[0_0_80px_rgba(0,0,0,0.15)]"
      >
        <div className="bg-background relative z-40">
          <Navbar
