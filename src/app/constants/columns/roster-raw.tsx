...
export const ROSTER_RAW_COLUMNS = [
  ...
  { key: "gio_vao", label: "From", type: "text" as const, width: 90, cellClassName: "font-mono font-bold text-slate-700", render: (val: unknown) => formatTime12Hour(val) },
  { key: "gio_ra", label: "To", type: "text" as const, width: 90, cellClassName: "font-mono font-bold text-slate-700", render: (val: unknown) => formatTime12Hour(val) },
